  ...
  parcial1=class
    private
     ...
     function Frac_dec_bin (n:double):string; //0.23 a binario
       ...
       procedure ord_burb();  //ascendente
        procedure ord_burb_Desc();  //descendente
       procedure invertir();
...
procedure parcial1.ord_burb_Desc;
  var
i,j,aux:integer;
begin
 for i:=1 to dim do begin

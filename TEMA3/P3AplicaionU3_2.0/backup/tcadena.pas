   ...
   cadena=class
     private
       ...
       public
        ...
        function encriptar_pal(x:string; d:byte):string;
        function desencriptar_pal(x:string; d:byte):string;
...
function cadena.encriptar_pal(x: string; d: byte): string;
...
function cadena.desencriptar_pal(x: string; d: byte): string;
  const abc = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
var n,i : Cardinal;
      p : byte;
      r : string;

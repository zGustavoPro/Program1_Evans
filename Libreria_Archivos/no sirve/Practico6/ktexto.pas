...
uses
  Classes, SysUtils,TCadena,Tconjunto,Pcadena;
type
    ...
    private
     ...
     procedure Copiar(A: ptexto; nombre: String);
      ...
      procedure invertirpal();
       ...
       procedure Mayor_Promedio(var Promedio:real; Mayor:string);
...
procedure PTexto.Mayor_Promedio(var Promedio: real; Mayor: string);
  var cad: Cadena;

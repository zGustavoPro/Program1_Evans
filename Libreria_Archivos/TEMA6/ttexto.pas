...
uses
  Classes, SysUtils,TCadena,Tconjunto,Dialogs;
type
    ...
    private
     ...
     procedure Copiar(A: ptexto; nombre: String);
      ...
      procedure invertirpal();
       ...
       Function cifrarArchivo(pal:string):string;
...
procedure PTexto.crearTxT;
 begin
   ...
   rewrite(f);
    ...
    close(f);
     ShowMessage('Archivo txt creado');
end;
...
procedure PTexto.MayorYpromedio(var promedio: real; var mayor: string);
var cad: Cadena;
...
function PTexto.cifrarArchivo(pal: string): string;

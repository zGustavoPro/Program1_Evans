...
type
  ...
  TForm1 = class(TForm)
    ...
    DP: TMenuItem;
    DS: TMenuItem;
    cargar_RandomM2: TMenuItem;
    Ord_1elem_Cfila: TMenuItem;
    Ord_FilxFil: TMenuItem;
    Ord_TDS: TMenuItem;
    Ord_TDP: TMenuItem;
    Random: TMenuItem;
    Transponer_TDP: TMenuItem;
    Parcilal: TMenuItem;
    Salir: TMenuItem;
    TII: TMenuItem;
    TID: TMenuItem;
    ...
    procedure cargar_RandomM2Click(Sender: TObject);
    ...
    procedure Ord_1elem_CfilaClick(Sender: TObject);
    procedure Ord_AscClick(Sender: TObject);
    procedure Ord_FilxFilClick(Sender: TObject);
    procedure Ord_TDPClick(Sender: TObject);
    procedure Ord_TDSClick(Sender: TObject);
    ...
    procedure Transponer_TDPClick(Sender: TObject);
...
procedure TForm1.cargar_RandomM2Click(Sender: TObject);
var
  f,c:integer;
begin
   f:=StrToInt(inputbox('Numero de fila','',''));
  c:=StrToInt(inputbox('Numero de columna','',''));
  M2.cargar_Ram(f,c);
  updateSG2();
end;
...
procedure TForm1.Ord_1elem_CfilaClick(Sender: TObject);
begin
 M1.Ord_1er_elem();
 updateSG1();
end;
...
procedure TForm1.Ord_FilxFilClick(Sender: TObject);
begin
 M1.Ord_Mfila();
 updateSG1();
end;

procedure TForm1.Ord_TDPClick(Sender: TObject);
begin
  M1.Ord_Triangulares_DP();
  updateSG1();
end;

procedure TForm1.Ord_TDSClick(Sender: TObject);
begin
 M1.Ord_Triangulares_DS();
 updateSG1();
end;
...
procedure TForm1.Transponer_TDPClick(Sender: TObject);
begin
 M1.TransPoner_DP();
 updateSG1();
end;
